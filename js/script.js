...
function verifyCondi() {
    if (perpresenca >= 75) {
        if (media >= 6) {
            document.getElementById("saidaVerifyCond").innerText = ("aprovado por ter nota e persencas suficientes")
        } else if ((media >= 5) && (media <= 6)) {
            document.getElementById("saidaVerifyCond").innerText = ("Recuperação por ter presenças o suficiente mas não ter as devidas notas")
            } else if(media < 5) {
            document.getElementById("saidaVerifyCond").innerText = ("reprovado por não ter notas suficientes")
            }
    }else {
        document.getElementById("saidaVerifyCond").innerText = ("Reprovado por não ter presenças o suficiente")
    }
